...
/**
 * Created by erichorvat on 5/17/15.
 */
...
public class PowerBar extends Rectangle{
        ...
        // Constructors
        // ===========================================================
        public PowerBar(final float pX, final float pY, final float pWidth, final float pHeight, float pMaxValue, float pStartValue, VertexBufferObjectManager tvbom) {
            super(pX, pY, pWidth, pHeight, tvbom);
            this.mProgressRectangle = new Rectangle(0, 0, pWidth, pHeight, tvbom);
            this.mProgressRectangle.setAnchorCenter(0,0);
        ...
        // Getter & Setter
        // ===========================================================
        public PowerBar setBackColor(final float pRed, final float pGreen, final float pBlue, final float pAlpha) {
            this.setColor(pRed, pGreen, pBlue, pAlpha);
            return this;
        }

        public PowerBar setFrameColor(final float pRed, final float pGreen, final float pBlue, final float pAlpha) {
            for (int i = 0; i < this.mFrameLines.length; i++)
                this.mFrameLines[i].setColor(pRed, pGreen, pBlue, pAlpha);
            return this;
        }

        public PowerBar setProgressColor(final float pRed, final float pGreen, final float pBlue, final float pAlpha) {
         ...
         */
        public PowerBar setProgress(float pProgress) {
         ...
         */
        public PowerBar setMax(final float pMax) {
            this.mMaxValue = pMax;
            return this;
        }
